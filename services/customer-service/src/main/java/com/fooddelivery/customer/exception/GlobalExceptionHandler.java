 ...
 * across all controllers in the customer-service.
 */
...
public class GlobalExceptionHandler {
     ...
     * a customer profile does not exist in the database.
     * Example: customer not found by customerId or userId.
     *
     ...
     * Example: customer profile already exists for the given userId.
     *
     * @param ex the exception containing the error message
     ...
     * Example: missing userId, missing customerName.
     *
